...
static const char *journal[]  = { "journal", NULL };
static const char *exercise[]  = { "exercise", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_e,      spawn,          {.v = passmenu } },
 	{ MODKEY|ShiftMask,             XK_j,      spawn,          {.v = journal } },
 	{ MODKEY|ShiftMask,             XK_e,      spawn,          {.v = exercise } },
